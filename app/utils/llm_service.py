...
class LLMService:
    ...
    def get_daily_data(self, user_id: int, select_date: datetime.date) -> Tuple[bool, Optional[Dict], str]:
        ...
        try:
            ...
            data = {
                ...
                'diary': [{'diary': diary.content, 'select_date': diary.select_date}] if diary else [],
    ...
    def get_chat_response(self, user_id: int, question: str) -> Tuple[bool, str]:
        ...
        이 외에도 지난 주에 있었던 다양한 일상적인 활동이나 일정을 자연스럽게 추가하여 대답해 주세요. 예를 들어, 특정한 감정이나 경험, 추가적인 할 일이나 일정 등을 포함할 수 있습니다.
    ...
    def create_feedback(self, user_id: int, select_date: datetime.date) -> Tuple[bool, str]:
        ...
        system_prompt = """
            ...
            와 같이 지난 주에 있었던 다양한 일상적인 활동이나 일정을 자연스럽게 추가하여 대답해 주세요. 
            예를 들어, 특정한 감정이나 경험, 추가적인 할 일이나 일정 등을 포함할 수 있습니다.
    ...
    def create_recommendation(self, user_id: int) -> Tuple[bool, str]:
        ...
        system_prompt = """
            ...
            위와 같이 지난 주에 있었던 다양한 일상적인 활동이나 일정을 자연스럽게 추가하여 대답해 주세요. 
            예를 들어, 특정한 감정이나 경험, 추가적인 할 일이나 일정 등을 포함할 수 있습니다.
